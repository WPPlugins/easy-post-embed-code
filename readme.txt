...
Tags: embed, code, oembed, copy, post
...
- Find your embed code right on the post edit screen
...
1. The embed code meta box on the post edit screen.
2. The full post edit screen (so you can see the meta box in context).
